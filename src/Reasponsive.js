...
function Responsive(){
   return(
       <div >
           <div className=" w-100 md:w-200 lg:w-300 bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl p-20 max-w-md mx-auto">
               <div className="md:flex">
                   <div className="md:flex-shrink-0">
                       <img className="h-48 w-full object-cover md:w-48" src="store.jpg"
